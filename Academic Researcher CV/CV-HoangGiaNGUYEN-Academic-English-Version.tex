...
\address{Date of Birth: 22/09/1990}{Address: Apartment 22, 3 allée Léon Blum}{59260, HELLEMMES, Lille, France}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\tlcventry{2020}{2018}{Postdoctoral Researcher}{INRIA (National Institute for Research in Computer Science and Automation)}{}{Lille, France}{\textbf{Research Project:} Design of Correct-by-Construction Self-Adaptive Cloud Applications Using Formal Methods.}
%{Also completed several random courses}


\tlcventry{2014}{2015}{Intern}{LIPN (Northern Paris Computer Science Laboratory) - Paris 13 University}{}{Villetaneuse, France}{}

\tlcventry{2014}{2015}{Member}{SAVE (Laboratory of Systems Analysis and VErification) - Ho Chi Minh City University of Technology}{}{Ho Chi Minh City, Vietnam}{}

\tlcventry{2010}{2012}{E-Commerce System Developer and Administrator}{Hoang Cuong Electronic}{Ho Chi Minh, Vietnam}{}{}
...
% Format: \tlcventry{StartYear}{EndYear}{Job title}{Employer}{City}{Country (optional)}{General description no longer than 1--2 lines.\newline{}%
% Example:
\tlcventry{2015}{2017}{Tutor}{IUT (University Institutes of Technology) - Paris 13 University}{}{Villetaneuse, France}{
	\textbf{Courses:} Application for Network and Telecommunication, Database Foundation, Networking Foundation.%
	%	\begin{itemize}%
...
%\subsection{Selected Projects at Bordeaux University}
...
%\subsection{Selected Projects at Hoa Sen University}
...
%Main Works:%
%\begin{itemize}%
% \item Develop an application of using Data Mining’s algorithms (K-means, K-nearest ..etc) 
%% and Artificial Intelligence's algorithm 
% for Voice Security System. The input is voice sample, then analyzes to verify the identity of the individual.
%\end{itemize}}
...
\begin{itemize}
\item \textbf{Research Project:} \emph{Efficient Parametric Verification of Parametric Timed Automata} 
\item \textbf{Supervisors:} { Prof. Étienne ANDRÉ and Prof. Laure PETRUCCI }
\end{itemize}
}
%{Also completed several random courses}

\tlcventry{2012}{2014}{Master of Software Engineering (and Telecomunication)}{Bordeaux University (in cooperation with Paris 6 University)}{French Universities Program - Vietnam National University}{Ho Chi Minh, Vietnam}
{
\begin{itemize}
	\item \textbf{M2 - 2nd year:} 1st class student with GPA: 15.6.
		\begin{itemize}
			\item \textbf{Thesis:} \emph{Efficient Parametric Verification of Real-Time Systems} - Nominated for best thesis.
		\end{itemize}
	\item \textbf{M1 - 1st year:} 2nd class student with GPA: 14.4.
\end{itemize}
}
%{Also completed several random courses}

\tlcventry{2008}{2012}{Bachelor of Software Engineering}{Hoa Sen University}{Ho Chi Minh, Vietnam}{}{}
%{Also completed several random courses}

\tlcventry{2005}{2008}{Gifted student of mathematics, physics and chemistry}{Nguyen Chi Thanh High
School}{Ho Chi Minh, Vietnam}{}{}
...
%
%\cvitem{\textbf{Title}}{\emph{Efficient Parametric Verification of Parametric Timed Automata}}
...
%\cvitem{\textbf{Title}}{\emph{Efficient Parametric Verification of Real-Time Systems} - Nominated for best thesis }
%\cvitem{\textbf{Supervisors}}{ Assoc.~Prof. Étienne ANDRÉ and Prof. Laure PETRUCCI }
...
%
%\cvlistitem{\textbf{2014:} 1st class student in 2nd year of master (M2) with GPA: 15.6. \\ 				\textbf{Thesis:} \emph{Efficient Parametric Verification of Real-Time Systems} - Nominated for best thesis. }
%
...
\cvlistitem{Étienne André, Hoang Gia Nguyen and  Laure Petrucci. \textbf{Distributed non-Zenoness parametric model checking (journal version)}. Submitted. }

\cvlistitem{Hoang Gia Nguyen, Laure Petrucci, and Jaco van de Pol. \textbf{Layered and Collecting NDFS with Subsumption for Parametric Timed Automata}. 23nd International Conference on Engineering of Complex Computer Systems, IEEE CPS {ICECCS 2018}. }

\cvlistitem{Étienne André, Hoang Gia Nguyen and Laure Petrucci. \textbf{Efficient parameter synthesis using optimized state exploration strategies}. 22nd International Conference on Engineering of Complex Computer Systems, IEEE CPS {ICECCS 2017}. }

\cvlistitem{Étienne André, Hoang Gia Nguyen,  Laure Petrucci and Sun Jun. \textbf{Parametric model checking timed automata under non-Zenoness assumption}. 
9$^{th}$ NASA Formal Methods Symposium {NFM 2017}. 
}

\cvlistitem{Étienne André, Giuseppe Lipari, Hoang Gia Nguyen and Youcheng Sun. \textbf{Reachability Preservation Based Parameter Synthesis for Timed Automata}. 
...
%\begin{enumerate}
%	\item \cvlistitem{Étienne André, Hoang Gia Nguyen and  Laure Petrucci. \textbf{Distributed Parametric model checking timed automata under non-Zenoness assumption (journal)}. will be submit soon. }
%	
%	\item \cvlistitem{Hoang Gia Nguyen, Laure Petrucci, and Jaco van de Pol. \textbf{LTL model checking for Parametric Timed Automata}. under submission. }
%	
%	\item \cvlistitem{Étienne André, Hoang Gia Nguyen and Laure Petrucci. \textbf{Efficient parameter synthesis using optimized state exploration strategies}. 22nd International Conference on Engineering of Complex Computer Systems,IEEE CPS {ICECCS 2017}. }
%	
%	\item \cvlistitem{Étienne André, Hoang Gia Nguyen,  Laure Petrucci and Sun Jun. \textbf{Parametric model checking timed automata under non-Zenoness assumption}. 
%		9$^{th}$ NASA Formal Methods Symposium {NFM 2017}. 
%	}
%	
%	\item \cvlistitem{Étienne André, Giuseppe Lipari, Hoang Gia Nguyen and Youcheng Sun. \textbf{Reachability Preservation Based Parameter Synthesis for Timed Automata}. 
%		%In Klaus Havelund, Gerard Holzmann, Rajeev Joshi (eds.), 
%		7$^{th}$ NASA Formal Methods Symposium {NFM 2015}.
%		%LNCS9058, Springer, pages 50–65, April 2015. Acceptance rate: 31\%. 
%	}
%	
%	\item \cvlistitem{Étienne André, Camille Coti, Hoang Gia Nguyen, \textbf{Enhanced Distributed Behavioral Cartography of Parametric Timed Automata}, 17$^{th}$ International Conference on Formal Engineering Methods ICFEM 2015.}
%\end{enumerate}
...
\cvlistitem{\textbf{JavaBIP - Coordination of concurrent Java components using a Java flavour of the BIP (Behaviour, Interactions, Priorities) framework} \\ \url{http://risd.epfl.ch/javabip} or \url{https://github.com/sbliudze}
\\
\url{https://github.com/hoangia90} (For Cloud Services)}
...
\cvlistitem{\textbf{Efficient Parameter Synthesis Using Optimized State Exploration Strategies}, 22nd International Conference on Engineering of Complex Computer Systems - ICECCS 2017, Fukuoka, Japan.}

\cvlistitem{\textbf{Parametric Model Checking Timed Automata Under non-Zenoness Assumption}, 9th NASA Formal Methods Symposium - NFM 2017, California, USA.}
...
\cvitem{\textbf{Formal Methods}}{
	Model Checking and Theorem Proving.
	\begin{itemize}
		\item \textbf{Formalisms:} Time Automata, Parametric Timed automata, Temporal Logic, Petri Nets, Event-B.
...
\cvitem{\textbf{Parallel Programming}}{Designing distributed algorithms with using MPI/OpenMP, akka.}

\cvitem{\textbf{Languages}}{C, C++, C\#, Java(EE), Ocaml, Python, Prolog, Batch, Shell, HTML, XML, CSS, JavaScript/AJAX, etc.}

\cvitem{\textbf{Databases}}{Oracle Database, MS SQL, ODBMS, MySQL, Postgre.}

%\cvitem{\textbf{Tools}}{Microsoft Visual Studio, Eclipse IDE, NetBean IDE, Borland C++, Code::Block, SVN, Git, Maven.}

\cvitem{\textbf{OOAD/OOP}}{Object Oriented Analysis (OOA), Object Oriented Design (OOD), Object Oriented Programming (OOP), Unified Modeling Language (UML).}
...
%\cvitem{\textbf{Framework \& Library}}{.NET, BACKBONE.}

%\cvitem{\textbf{Servers}}{Apache Tomcat, Jetty, Glassfish, IIS.}

%\cvitem{\textbf{Web Service}}{Restful, SOAP Web services.}

\cvitem{\textbf{Other skills}}{LaTex, Microsoft Office.}

%\cvitem{\textbf{Parallel Programming}}{MPI, OpenMP, Ocaml/MPI}

\cvitem{\textbf{Telecoms \& Networking}}{Strong knowledge of computer networking and telecommunications }
...
%% Format: \tlcventry{StartYear}{EndYear}{Job title}{Employer}{City}{Country (optional)}{General description no longer than 1--2 lines.\newline{}%
%% Example:
%\tlcventry{2015}{2017}{Tutor}{\textbf{IUT-Paris 13 University}}{}{}{
%	Courses: Application for Network and Telecommunication, Database Foundation, Networking Foundation.%
%%	\begin{itemize}%
%%		\item Application for network and telecommunication
%%		\item Database foundation
%%		\item Networking foundation
...
%}
%
%\tlcventry{2010}{2012}{E-Commerce System Developer and Administrator}{\textbf{Hoang Cuong Electronic}}{Ho Chi Minh City - Vietnam}{}{
%%	Did system administration work.\newline
%{}%
%%Main Duties:%
%%\begin{itemize}%
%% \item Administrate the servers;
...
\subsection{INRIA Laboratory}
\cvlistitem{\cvreference{Senior Researcher Simon BLIUDZE}{}{}{}{}{Simon.bliudze@inria.fr}{}{}}
%		Senior Researcher, INRIA Laboratory, Lille, France

\subsection{LIPN Laboratory - Paris 13 University}
%\cvreferencecolumn{\cvreference{John Doe}{Developer}{HR}{Simple Solutions}{MyCity}{john@email.com}{+12 (34) 567 8901}{+23 (45) 678 9012}}{\cvreference{Jane Doe}{Accountant}{HR}{Simple Solutions}{MyCity}{jane@email.com}{+34 (56) 789 0123}{+45 (67) 890 1234}} 

\cvlistitem{\cvreference{Professor Étienne ANDRÉ}{}{}{}{}{Etienne.Andre@univ-paris13.fr}{}{}}
%Professor, LIPN Laboratory, Villetaneuse - France

\cvlistitem{\cvreference{Professor Laure PETRUCCI}{}{}{}{}{Laure.Petrucci@lipn.univ-paris13.fr}{}{}}
%Professor, LIPN Laboratory, Villetaneuse - France
...
\cvlistitem{\cvreference{Associate Professor Anne DICKY}{}{}{}{}{Anne.Dicky@labri.fr}{}{}}
%Associate Professor, 
%%Director of Bordeaux University Software Engineering Program in Ho Chi Minh City, 
...
\cvlistitem{\cvreference{Associate Professor Thanh Tho QUAN}{}{}{}{}{QTTho@cse.hcmut.edu.vn}{}{}}
%Associate Professor, Head of Department of Software Engineering, University of Technology, Ho Chi Minh - Vietnam
...
\cvitemwithcomment{French}{Intermediate}{Learning since 2015}
...
\cvitem{Research}{Model Checking and Verification, Distributed Computing, Artificial Intelligence, Big Data and Data Mining, Cloud Computing.}
\cvitem{Leisure}{Exploring new Technologies, Photography, Swimming, Hiking, Reading Books, Travel, Watching Movies.}
